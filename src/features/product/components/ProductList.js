          ...
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <section aria-labelledby="products-heading" className="pb-24 pt-6">
                ...
                <div className="filter-options grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  {/* Filters */}
...
function DesktopFilter({ handleFilter, filters }) {
  return (
    <form className="hidden lg:block lg:sticky lg:top-4 lg:overflow-y-auto lg:overflow-x-hidden lg:max-h-screen">
      <h2 className="text-lg font-medium text-gray-900">Filters</h2>
        ...
        <Disclosure as="div" key={section.id} className="border-b border-gray-200 py-6">
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="pt-6 max-h-96 overflow-x-hidden overflow-y-auto">
